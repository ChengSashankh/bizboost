...
class VDPInterface {
    ...
    searchForATM() {
        var options = {
            ...
            body: JSON.stringify({
                "wsRequestHeaderV2":{
                    "requestTs":"2020-10-19T09:20:38.000Z","requestMessageId":"test12345678","userBid":"10000108","correlationId":"909420141104053819418","applicationId":"VATMLOC","userId":"CDISIUserID"
                },
                "requestData":{
                    "distanceUnit":"mi","distance":"20","culture":"en-US","options":{
                        "findFilters":[
                            {"filterValue":"C","filterName":"OPER_HRS"},
                            {"filterValue":"","filterName":"AIRPORT_CD"},
                            {"filterValue":"N","filterName":"WHEELCHAIR"},
    ...
    searchForMerchant (searchQuery) {
        ...
        var options = {
            ...
            body: JSON.stringify({
                ...
                "searchAttrList":{"distanceUnit":"M","distance":"2","merchantCountryCode":"840","latitude":"37.363922","longitude":"-121.929163","merchantName": searchQuery},
    ...
    addTravelItinerary(requestBody) {
        console.log("Adding travel itinerary");
