...
const merchants = [
    ...
    {
        "visaMerchantName": "EMILY'S RAMEN HOUSE",
        "visaStoreName": "STARBUCKS",
        "merchantCity": "SAN JOSE",
        "merchantState": "CA",
        "merchantCountryCode": "840",
        ...
        return (
            <div>
                ...
                <Grid container spacing={2} className="grid">
                    <Grid item xs={12}>
                        <TextField variant="standard" placeholder="food" className="button"></TextField>
